...
def genereer_html_kaart(woningen, output_file="buurt_kaart.html", titel="Buurtdata Kaart", cbs_data=None):
    """
    ...
    - Klik popup met alle details inclusief geveloriëntatie
    - CBS buurtdata panel
    """
    ...
    for w in woningen:
        ...
        # Geveloriëntatie met kompas emoji
        if w.get('gevel_orientatie'):
            gevel = w.get('gevel_orientatie')
            kompas_emoji = {
                'N': '⬆️', 'NO': '↗️', 'O': '➡️', 'ZO': '↘️',
                'Z': '⬇️', 'ZW': '↙️', 'W': '⬅️', 'NW': '↖️'
            }.get(gevel, '🧭')
            popup_lines.append(f"<b>Voorgevel:</b> {kompas_emoji} {gevel}")
    ...
    if cbs_data:
        ...
        <div class="cbs-panel">
            ...
            <div class="cbs-section">
                ...
                <div class="cbs-row"><span>Gem. WOZ:</span><span>€{cbs_data.get('gem_woz_k', '-')}k</span></div>
            </div>
            <div class="cbs-section">
                <b>Inkomen</b>
                <div class="cbs-row"><span>Gem. inkomen:</span><span>€{cbs_data.get('gem_inkomen_k', '-')}k</span></div>
...
""")
    ...
    genereer_html_kaart(woningen, "buurt_kaart.html", kaart_titel, cbs_data=cbs_data)
